...
We analyze second-hand car prices from the [Craigslist Used Cars Dataset](https://www.kaggle.com/datasets/austinreese/craigslist-carstrucks-data) with the goal of **predicting the price** of a used vehicle based on its features.

## Overview

- **Dataset:** ~426,000 rows, 26 columns
- **Goal:** Predict used car prices using regression models
- **Tools:** Python, Jupyter, Scikit-learn, XGBoost, TensorFlow/Keras
...
```bash
git clone https://github.com/Marwa-AlHajriy/2nd-hand-car-price.git
cd 2nd-hand-car-price
```
